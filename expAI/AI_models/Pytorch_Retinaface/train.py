...
# parser.add_argument('--training_dataset', default='./AI_models/Pytorch_Retinaface/data/widerface/train/label.txt', help='Training dataset directory')
...
# parser.add_argument('--save_folder', default='./AI_models/Pytorch_Retinaface/weights/', help='Location to save checkpoint models')
...
# def train(dataset_path,json_config):
